...
import 'dotenv/config'; // Carga las variables de entorno del .env
...
const oldEquipmentData = [
  {
    "_id": new mongoose.Types.ObjectId("68dc50e9db5c735854b56591"),
  ...
  {
    "_id": new mongoose.Types.ObjectId("68dc510bdb5c735854b56593"),
  ...
  {
    "_id": new mongoose.Types.ObjectId("68dc515bdb5c735854b56595"),
  ...
  {
    "_id": new mongoose.Types.ObjectId("68dc51aedb5c735854b56597"),
  ...
  {
    "_id": new mongoose.Types.ObjectId("68dc51d2db5c735854b56599"),
...
const oldConsumablesData = [
  {
    "_id": new mongoose.Types.ObjectId("68dc525adb5c735854b5659d"),
  ...
  {
    "_id": new mongoose.Types.ObjectId("68dc5277db5c735854b5659f"),
  ...
  {
    "_id": new mongoose.Types.ObjectId("68dc528bdb5c735854b565a1"),
...
const runMigration = async () => {
  ...
  try {
    ...
    for (const old of oldEquipmentData) {
        ...
        await Equipment.create(newEquip);
    }
    ...
    for (const old of oldConsumablesData) {
        ...
        await Consumable.create(newConsume);
    }
    ...
    for (const superItem of newSuperConsumablesData) {
        await Consumable.create({ ...superItem, tipoItem: 'Consumable' });
    }
