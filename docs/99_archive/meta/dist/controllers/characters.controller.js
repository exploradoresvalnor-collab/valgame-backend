...
exports.levelUpCharacter = exports.evolveCharacter = exports.addExperience = exports.healCharacter = exports.useConsumable = exports.reviveCharacter = void 0;
...
const evolveCharacter = async (req, res) => {
    ...
    try {
        ...
        try {
            ...
            realtimeService.notifyCharacterEvolved(userId, characterId, characterToEvolve.etapa);
            ...
            try {
                ...
                console.warn('[evolveCharacter] No se pudo crear notificación:', e?.message || e);
            }
        }
        catch (err) {
            if (process.env.NODE_ENV !== 'test') {
...
exports.levelUpCharacter = levelUpCharacter;
