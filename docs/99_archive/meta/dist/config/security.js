...
exports.getSecurityInfo = exports.validateSecurityConfig = exports.getJWTSecret = void 0;
/**
...
const getJWTSecret = () => {
    ...
    if (!secret) {
        throw new Error('🔴 CRÍTICO: JWT_SECRET no configurado en variables de entorno.\n' +
            'Genera uno con: node -e "console.log(require(\'crypto\').randomBytes(64).toString(\'hex\'))"');
    }
    if (secret.length < 32) {
        console.warn('⚠️  ADVERTENCIA: JWT_SECRET tiene menos de 32 caracteres.\n' +
...
const validateSecurityConfig = () => {
    ...
    if (process.env.NODE_ENV === 'production') {
        ...
        if (missing.length > 0) {
            throw new Error(`🔴 CRÍTICO: Variables de entorno faltantes en producción: ${missing.join(', ')}`);
        }
