 ...
 */
export function calcularPuntosRequeridos(nivelActual: number): number {
 ...
 */
export function calcularPuntosVictoria(
  tiempoSegundos: number,
  tiempoEstimado: number,
  saludRestantePorcentaje: number,
  rachaActual: number
): number {
 ...
 */
export function calcularTiempoEstimado(vidaBoss: number, ataqueBoss: number): number {
 ...
 */
export function procesarVictoria(
  progresoActual: {
    victorias: number;
    derrotas: number;
    nivel_actual: number;
  ...
  tiempoVictoria: number
): {
  progreso: typeof progresoActual;
  subiDeNivel: boolean;
 ...
 */
export function calcularStatsEscaladas(
  statsBase: { vida: number; ataque: number; defensa: number },
  nivelMazmorra: number,
  multiplicadores: { multiplicador_stats_por_nivel: number }
): { vida: number; ataque: number; defensa: number } {
 ...
 */
export function calcularRecompensasEscaladas(
  recompensasBase: { expBase: number; valBase: number },
  nivelMazmorra: number,
  multiplicadores: { 
    multiplicador_xp_por_nivel: number;
    multiplicador_val_por_nivel: number;
  }
 ...
 */
export function calcularMultiplicadorDrop(
  nivelMazmorra: number,
  multiplicadorPorNivel: number
): number {
