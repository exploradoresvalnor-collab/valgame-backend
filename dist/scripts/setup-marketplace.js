...
async function setupMarketplace() {
    try {
        ...
        const stats = {
            items: await Equipment_1.Equipment.countDocuments(),
            consumibles: await Consumable_1.Consumable.countDocuments(),
            usuarios: await User_1.User.countDocuments(),
            listings: await Listing_1.default.countDocuments()
        };
        ...
        const checkResults = await Promise.all([
            Equipment_1.Equipment.findOne(),
            Consumable_1.Consumable.findOne(),
            User_1.User.findOne()
        ]);
