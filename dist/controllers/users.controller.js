    ...
    try {
        ...
        res.json({
            ...
            personajes: user.personajes && user.personajes.length > 0
                ? user.personajes.slice(0, 5).map((p) => ({
