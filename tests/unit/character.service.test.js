...
const character_service_1 = require("../../src/services/character.service");
describe('calcularXpPorRango', () => {
    ...
    test('rango D debe requerir menos victorias que SSS con mismos parametros', () => {
        const resD = (0, character_service_1.calcularXpPorRango)(10, 'D', levelReq, expBase, settings);
        const resSSS = (0, character_service_1.calcularXpPorRango)(10, 'SSS', levelReq, expBase, settings);
